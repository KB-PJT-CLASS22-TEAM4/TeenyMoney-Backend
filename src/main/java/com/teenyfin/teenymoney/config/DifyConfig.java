...
// RestTemplateConfig(토스 전용)와 굳이 분리한 이유: 지금 당장은 둘 다 값이 비슷해 보여도
// (readTimeout 120초로 동일), "같은 설정을 공유한다"는 사실 자체가 문제였다 - 나중에 둘 중
...
public class DifyConfig {
    ...
    // 짧게 잡는다 - 이건 사용자 규모와 무관하게 항상 맞는 값이라 5초로 고정.
