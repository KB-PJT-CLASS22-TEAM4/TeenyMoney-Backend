...
public enum PermissionErrorCode implements ErrorCode {
    ...
    DUPLICATE_TODAY_PERMISSION_REQUEST(HttpStatus.BAD_REQUEST, "오늘 이미 해당 카테고리로 오늘만 허용을 요청했습니다."),
    ...
    ONLY_PARENT_CAN_MANAGE_PERMISSION_LIMIT(HttpStatus.FORBIDDEN, "부모만 오늘만 허용 월간 한도를 조회·변경할 수 있습니다."),
